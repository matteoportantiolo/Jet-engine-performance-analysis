...
% dati presi dal ciclo completo con velocità fissata a 500mph=800km/h
v_in = 108.187155101845;     
rho1 = 0.559440041203149;
...
eta_p_x = 0.624428674983957;
incremento_eta_p = (eta_p-eta_p_x)/eta_p_x*100

eta_th_x = 0.157892954621089;
incremento_eta_th = (eta_th-eta_th_x)/eta_th_x*100

eta_g_x = 0.0985928884433485;
incremento_eta_g = (eta_g-eta_g_x)/eta_g_x*100
