...
for j=1:length(ALPHA)
    ...
    T3_tot_vera=393.481656012071; %N.B.: data la velocità e la quota a cui scegliamo di andare, vedere ciclo camo
    eta_c=0.78;
...
errore_temperature=100*abs(T3_tot(end,index)-T3_tot_vera)/T3_tot_vera;
...
%legend('andamento del rapporto P_2_t_o_t/P_1_t_o_t lungo gli stadi');
xlabel('Stadio del compressore')
