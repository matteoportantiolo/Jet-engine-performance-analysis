...
z = 0.3048.*[10000,20000,30000,36100,40000] %vettore quote
T_x = 4.4482216.*[1400,1050,730,560,420]; %vettore spinta obiettivo 
j = 1;
v_in = [25:10:250]; %vettore velocità
v_vect = zeros(5,1); %matrice spinta
...
g = 9.81;
T_amb=T_amb0-a*z(j);
p_amb=p_amb0*(1-(a*z(j))/T_amb0)^(g/(R_a*a));
rho_amb=p_amb/(R_a*T_amb);

i = 0;
T = 0;

while (abs(T-T_x(j))>300)
