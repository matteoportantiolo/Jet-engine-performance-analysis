function [THRUST, TSFC, T0, P0, rho0, T0_t, P0_t, rho0_t, A_in, T1, P1, rho1, a1, v_in,v_comp, M_volo, M_in, M_e, ...
                v_e, f, m_a, m_f, m_tot, P_p, P_dis, P_av, eta_p, eta_ter, eta_glob, P5_st, m_norm,I_sp,P1_tt,T1_tt,P2_tt,T2_tt]...
                = BMW003 (z, v_volo, pi_d, beta_c, eta_c_tot, eta_c, eta_b, pi_b, deltaH, eta_t_t, eta_t_m, eta_n)
